    ...
    <div id="trade_container">
      <div id="left_side">
        <div id="login_form">
          ...
          <mu-dialog :open="loginDialog" title="添加交易账户" @close="closeDialog">
            ...
            <mu-text-field
              label="账号(account_cookie)"
              class="demo-divider-form"
              :underlineShow="true"
              labelFloat
              @input="change_accountcookie"
            />
            <mu-text-field
              label="交易密码(回测不填)"
              class="demo-divider-form"
          ...
          <mu-dialog :open="advanceSetting" title="高级设置" @close="closeAdvancedSetting">
            <mu-switch label="风控" labelLeft v-model="risk_control" class="demo-switch"/>
            <br>
            <mu-text-field
              label="账号备注"
              class="demo-divider-form"
      ...
      <div class="mid_side">
        <div id="session_account">
          <mu-list>
            <mu-list-item disabled title="可用账户列表" describeText="powerbyQA"/>
          </mu-list>
          <mu-divider/>
      ...
      <div class="right_side">
        <div id="right_up">
          <div id="trade_panel">
            ...
            <br>
            <div>买入
              <mu-switch labelLeft v-model="order_towards" class="demo-switch"/>卖出
            </div>
            <br>
            <br>

            <mu-raised-button label="下单" class="demo-raised-button" @click="buy"/>
          </div>
          <div id="main"/>
        </div>
...
export default {
  ...
  methods: {
    ...
    get_stock_day(code) {
      ...
      this.code = code;
      axios
        .get("http://www.yutiansut.com:8010/marketdata/stock/day?code=" + code)
        .then(response => {
