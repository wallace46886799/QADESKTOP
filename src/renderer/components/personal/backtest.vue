...
export default {
  ...
  data () {
    return {
      ...
      items: [['loading', 'RBL8', 'loading', '多开', 'loading', 'xx', 'xxx', 'loading'], ['loading', 'RBL8', 'loading', '多开', 'loading', 'xx', 'xxx', 'loading']],
      time: [],
      itemss: [
        {
          alpha: 'loading..'
    ...
    getplotdata () {
      ...
      axios
        ...
        .then(response => {
          ...
          this.itemss[0]['annualized_returns'] = data['annualize_return'].toFixed(3)
          this.itemss[0]['benchmark_annualized_returns'] = data['bm_annualizereturn'].toFixed(3)
...
.mu-breadcrumb-item-link, .mu-breadcrumb-item-current, .mu-breadcrumb-item-separator {
  font-size: 28px;
