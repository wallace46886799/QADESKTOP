    ...
    <div @keyup="submit($event)">
      ...
      <mu-paper>
        <mu-drawer :open="open" :docked="false" @close="toggle()" :right="position === 'right'">
          <mu-appbar title="QUANTAXIS"></mu-appbar>
          ...
          <mu-menu>
            ...
            <router-link to="/personal/backtest">
              <mu-list-item class="menu_list" title="回测概览"></mu-list-item>
            </router-link>
            <router-link to="/personal/account">
              <mu-list-item class="menu_list" title="账户管理"></mu-list-item>
            </router-link>
            <router-link to="/personal/runbacktest">
              <mu-list-item class="menu_list" title="回测运行"></mu-list-item>
            </router-link>
            <router-link to="/personal/trade">
              <mu-list-item class="menu_list" title="实盘交易"></mu-list-item>
            </router-link>
            <mu-divider/>
            <mu-list-item class="menu_list" title="退出" @click="signout"/>
            <mu-list-item class="menu_list" @click="open = false" button></mu-list-item>
          </mu-menu>
        </mu-drawer>
      </mu-paper>
      <mu-content-block>
